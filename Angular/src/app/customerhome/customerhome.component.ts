  ...
  ngOnInit() {
   ...
   this.isLoggedIn = sessionStorage.getItem('isLoggedIn');
    if(this.isLoggedIn == "true")
    {
        ...
        this._accountService.getAccountsList(this.customerId).subscribe(data=>
          ...
          this.accountsList.forEach(accountObj => {
            ...
            this.acntNo=accountObj.accountNo;
 
             if(this.bal< 5000){
               console.log("< 5000");
               this._popupService.confirm('Balance for account '+this.acntNo, 'is less than 5000').then((confirmed) => console.log('User confirmed:', confirmed))
